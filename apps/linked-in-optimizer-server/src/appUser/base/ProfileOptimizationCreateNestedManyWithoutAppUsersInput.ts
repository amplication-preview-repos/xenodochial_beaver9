...
@InputType()
class ProfileOptimizationCreateNestedManyWithoutAppUsersInput {
...
export { ProfileOptimizationCreateNestedManyWithoutAppUsersInput as ProfileOptimizationCreateNestedManyWithoutAppUsersInput };

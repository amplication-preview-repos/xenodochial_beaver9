...
@InputType()
class ProfileOptimizationCreateNestedManyWithoutUsersInput {
...
export { ProfileOptimizationCreateNestedManyWithoutUsersInput as ProfileOptimizationCreateNestedManyWithoutUsersInput };
